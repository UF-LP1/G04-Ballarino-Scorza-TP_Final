...
cReceptor::cReceptor(string nombre, tm fechanac, char sexo, string peso, string tipos_sangre, string centro_salud, string rh, string fluido_recibe, string partido, string provincia,tm fecha_agregado_espera, unsigned int prioridad , estado estado_pac) :cPaciente(nombre, fechanac, sexo, peso, tipos_sangre, centro_salud,rh, fluido_elegido,partido, provincia) {
