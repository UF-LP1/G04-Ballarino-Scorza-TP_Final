...
int main() {
    ...
    pacientes.push_back(new cDonante("14356756", "rodrigo", obtenerFecha("17/6/1991"), 'm', "75kg", "O", "Hospital Ramos Mejía", "Positivo", "Medula osea", "CABA", "Buenos Aires", false, false, false, obtenerFecha("19/10/2022")));
    pacientes.push_back(new cDonante("15356756", "lucia", obtenerFecha("29/10/1996"), 'f', "60kg", "AB", "Hospital Ramos Mejía", "Negativo", "Plasma", "CABA", "Buenos Aires", true, false, false, obtenerFecha("2/4/2022")));
    pacientes.push_back(new cDonante("16356756", "oscar", obtenerFecha("3/12/1998"), 'm', "80kg", "B", "Hospital de Niños", "Positivo", "Medula osea", "La Plata", "Buenos Aires", false, false, false, obtenerFecha("20/3/2023")));
    ...
    pacientes.push_back(new cDonante("38356756", "luciano", obtenerFecha("20/2/1992"), 'm', "80kg", "A", "Hospital Regional Resistencia", "Positivo", "Medula osea", "Resistencia", "Chaco", false, false, false, obtenerFecha("12/7/2022")));
    ...
    //CARGO RECEPTORES
    pacientes.push_back(new cReceptor("42356756", "pepe", obtenerFecha("12/3/2000"), 'm', "90kg", "A", "Hospital Italiano", "Positivo", "Medula osea", "CABA", "Buenos Aires", obtenerFecha("12/5/2022"), 5, cReceptor::estado::inestable));
    ...
    pacientes.push_back(new cReceptor("62356758", "lucas", obtenerFecha("2/5/1995"), 'm', "80kg", "O", "Hospital Provincial", "Positivo", "Medula osea", "Catamarca", "Catamarca", obtenerFecha("20/5/2022"), 3, cReceptor::estado::inestable));//
    pacientes.push_back(new cReceptor("10356758", "luis", obtenerFecha("7/11/1997"), 'm', "70kg", "AB", "Hospital del Milagro", "Positivo", "Medula osea", "Salta", "Salta", obtenerFecha("21/5/2022"), 1, cReceptor::estado::estable));
    pacientes.push_back(new cReceptor("12356758", "fernando", obtenerFecha("9/8/1994"), 'm', "85kg", "B", "Hospital Regional Resistencia", "Positivo", "Medula osea", "Resistencia", "Chaco", obtenerFecha("22/5/2022"), 3, cReceptor::estado::inestable));
    pacientes.push_back(new cReceptor("14356756", "rodrigo", obtenerFecha("17/6/1991"), 'm', "75kg", "O", "Hospital Ramos Mejía", "Positivo", "Medula osea", "CABA", "Buenos Aires", obtenerFecha("23/5/2022"), 5, cReceptor::estado::inestable));
    pacientes.push_back(new cReceptor("16356758", "oscar", obtenerFecha("3/12/1998"), 'm', "80kg", "B", "Hospital de Niños", "Positivo", "Medula osea", "La Plata", "Buenos Aires", obtenerFecha("24/5/2022"), 2, cReceptor::estado::estable));
    pacientes.push_back(new cReceptor("17356758", "camila", obtenerFecha("16/1/1993"), 'f', "55kg", "O", "Hospital de Niños", "Negativo", "Sangre", "La Plata", "Buenos Aires", obtenerFecha("25/5/2022"), 3, cReceptor::estado::inestable));
    pacientes.push_back(new cReceptor("19356758", "valentina", obtenerFecha("12/10/1990"), 'f', "65kg", "B", "Hospital Alemán", "Negativo", "Plasma", "CABA", "Buenos Aires", obtenerFecha("26/5/2022"), 4, cReceptor::estado::estable));
    pacientes.push_back(new cReceptor("20356758", "julian", obtenerFecha("21/2/1988"), 'm', "80kg", "AB", "Hospital Pirovano", "Positivo", "Medula osea", "CABA", "Buenos Aires", obtenerFecha("27/5/2022"), 1, cReceptor::estado::estable));
    pacientes.push_back(new cReceptor("21356756", "soledad", obtenerFecha("14/5/1993"), 'f', "60kg", "O", "Hospital Pirovano", "Negativo", "Sangre", "CABA", "Buenos Aires", obtenerFecha("28/5/2022"), 2, cReceptor::estado::inestable));
    pacientes.push_back(new cReceptor("22356758", "lucas", obtenerFecha("30/9/1997"), 'm', "70kg", "A", "Hospital Durand", "Positivo", "Medula osea", "CABA", "Buenos Aires", obtenerFecha("29/5/2022"), 3, cReceptor::estado::estable));
    pacientes.push_back(new cReceptor("23356758", "mariana", obtenerFecha("18/3/1992"), 'f', "55kg", "B", "Hospital Durand", "Negativo", "Plasma", "CABA", "Buenos Aires", obtenerFecha("30/5/2022"), 4, cReceptor::estado::inestable));
    pacientes.push_back(new cReceptor("24356758", "martin", obtenerFecha("11/7/1995"), 'm', "75kg", "AB", "Hospital Argerich", "Positivo", "Medula osea", "CABA", "Buenos Aires", obtenerFecha("1/6/2022"), 5, cReceptor::estado::inestable));
    pacientes.push_back(new cReceptor("25356758", "natalia", obtenerFecha("23/12/1990"), 'f', "65kg", "O", "Hospital Argerich", "Negativo", "Sangre", "CABA", "Buenos Aires", obtenerFecha("2/6/2022"), 1, cReceptor::estado::inestable));
    pacientes.push_back(new cReceptor("26356758", "diego", obtenerFecha("9/11/1994"), 'm', "80kg", "A", "Hospital Británico", "Positivo", "Medula osea", "CABA", "Buenos Aires", obtenerFecha("3/6/2022"), 2, cReceptor::estado::estable));
    pacientes.push_back(new cReceptor("27356758", "romina", obtenerFecha("2/5/1989"), 'f', "60kg", "B", "Hospital Británico", "Negativo", "Plasma", "CABA", "Buenos Aires", obtenerFecha("4/6/2022"), 3, cReceptor::estado::inestable));
    pacientes.push_back(new cReceptor("28356758", "matias", obtenerFecha("17/3/1993"), 'm', "70kg", "AB", "Hospital Austral", "Positivo", "Medula osea", "Pilar", "Buenos Aires", obtenerFecha("5/6/2022"), 4, cReceptor::estado::estable));
    pacientes.push_back(new cReceptor("29356758", "ana", obtenerFecha("14/9/1988"), 'f', "55kg", "O", "Hospital Austral", "Negativo", "Sangre", "Pilar", "Buenos Aires", obtenerFecha("6/6/2022"), 5, cReceptor::estado::inestable));
    pacientes.push_back(new cReceptor("30356758", "roberto", obtenerFecha("28/1/1997"), 'm', "75kg", "A", "Hospital Español", "Positivo", "Medula osea", "CABA", "Buenos Aires", obtenerFecha("7/6/2022"), 1, cReceptor::estado::estable));
    pacientes.push_back(new cReceptor("32356756", "francisco", obtenerFecha("10/8/1995"), 'm', "80kg", "AB", "Hospital Italiano", "Positivo", "Medula osea", "CABA", "Buenos Aires", obtenerFecha("8/6/2022"), 2, cReceptor::estado::inestable));
    ...
    pacientes.push_back(new cReceptor("53356758", "camila", obtenerFecha("29/9/1990"), 'f', "65kg", "O", "Hospital Británico", "Negativo", "Sangre", "CABA", "Buenos Aires", obtenerFecha("29/6/2022"), 3, cReceptor::estado::estable));
    pacientes.push_back(new cReceptor("54356758", "juan", obtenerFecha("2/11/1994"), 'm', "75kg", "A", "Hospital Austral", "Positivo", "Plasma", "Pilar", "Buenos Aires", obtenerFecha("30/6/2022"), 5, cReceptor::estado::inestable));
