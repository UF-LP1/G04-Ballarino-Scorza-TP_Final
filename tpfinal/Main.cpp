...
int main()
{
    ...
    //CARGO DONANTES
    pacientes.push_back(new cDonante(42356756, "pepe", obtenerFecha("12/3/2000"), 'm', "90kg", "A", "Hospital Italiano", "Positivo", "Medula osea", "CABA", "Buenos Aires", false, false, false, obtenerFecha("18/6/2023")));
    pacientes.push_back(new cDonante(52356756, "juan", obtenerFecha("4/7/1998"), 'm', "70kg", "B", "Hospital Italiano", "Negativo", "Sangre", "CABA", "Buenos Aires", true, false, true, obtenerFecha("18/6/2023")));
    ...
    pacientes.push_back(new cDonante(19356756, "valentina", obtenerFecha("12/10/1990"), 'f', "65kg", "B", "Hospital Alemán", "Negativo", "Plasma", "CABA", "Buenos Aires", true, true, false, obtenerFecha("4/5/2022")));
    ...
    //CARGO RECEPTORES
    pacientes.push_back(new cReceptor(42356756, "pepiie", obtenerFecha("12/3/2008"), 'm', "99kg", "A", "Hospital Italiano", "Positivo", "Medula osea", "CABA", "Buenos Aires",obtenerFecha("10/10/2010"), 3, cReceptor::estado::inestable));
