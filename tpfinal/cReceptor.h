...
private:
	...
	estado estado_pac;
public:
	cReceptor(const  int id,string nombre, tm fechanac, char sexo, string peso, string tipos_sangre, string centro_salud, string rh, string fluido_elegido, string partido, string provincia, tm fecha_agregado_espera,unsigned int prioridad, estado estado_pac);
